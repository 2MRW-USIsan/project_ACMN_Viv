...
import { SwitchItemFormType } from "@/types/components/ui";

interface SwitchItemFormProps {
  props: SwitchItemFormType;
}
export function SwitchItemForm({ props }: SwitchItemFormProps) {
  return (
