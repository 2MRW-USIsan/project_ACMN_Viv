...
export function usePromptForgerViewModelMocks(): PromptForgerViewModelMocksReturns {
  ...
  const [selectedForgerId, setSelectedForgerId] = useState<string>(MOCK_FORGER_ITEMS[0].id);
  ...
  const [selectedAngle, setSelectedAngle] = useState<"above" | "horizontal" | "below">("horizontal");
  const [selectedDirection, setSelectedDirection] = useState<"front" | "side" | "back">("side");

  // Switch states for bloc1 grp1
  const [bloc1Grp1Switches, setBloc1Grp1Switches] = useState<boolean[]>([true, false, true, false, true]);
  const [bloc1Grp2Switches, setBloc1Grp2Switches] = useState<boolean[]>([false, true, false, true, true]);

  // Switch states for bloc2 grp1
  const [bloc2Grp1Switches, setBloc2Grp1Switches] = useState<boolean[]>([true, true, false, true, false]);
  const [bloc2Grp2Switches, setBloc2Grp2Switches] = useState<boolean[]>([false, false, true, true, false]);
  ...
  const handleSummaryPromptBlur = (value: string) => setSummaryPromptValue(value);
  ...
  const bloc1SwitchItemLabels = ["[Item Label]", "[Item Label]", "[Item Label]", "[Item Label]", "[Item Label]"];
  const bloc2SwitchItemLabels = ["[Item Label]", "[Item Label]", "[Item Label]", "[Item Label]", "[Item Label]"];
    ...
    viewModel: {
      ...
      promptForgerBody: {
              ...
              grpPanels: [
                {
                  ...
                  displayLines: [
                    { text: "• [Item Label]: [Random Value] [Random Prompt] [Random Prompt]  • [Item Label]: [Complex Value] [Complex Prompt]", variant: "body2" },
                    { text: "• [Item Label]: [Color Value]", variant: "body2" },
                    { text: "• [Item Label]:", variant: "body2" },
                  ],
                  scriptsLabel: { text: "[-----Scripts Text---------------------------------------------]", variant: "body2" },
                  promptLabel: { text: "Prompt:", variant: "body2" },
                  promptField: {
                    placeholder: "text field...",
                    defaultValue: bloc1Grp1OrdersPrompt,
                    onBlur: setBloc1Grp1OrdersPrompt,
                    size: "small",
                    fullWidth: true,
                  },
                ...
                },
                {
                  ...
                  promptField: {
                    placeholder: "text field...",
                    defaultValue: bloc1Grp2OrdersPrompt,
                    onBlur: setBloc1Grp2OrdersPrompt,
                    size: "small",
                    fullWidth: true,
                  },
                  resetButton: { label: "Reset", onClick: () => {}, size: "small" },
                  ...
                  switchItems: bloc1SwitchItemLabels.map((label, i) => ({
                    ...
                    switchControl: {
                      ...
                      onChange: (checked: boolean) =>
                        setBloc1Grp1Switches((prev) => prev.map((v, idx) => (idx === i ? checked : v))),
                    },
                  })),
                },
                {
                  ...
                  switchItems: bloc1SwitchItemLabels.map((label, i) => ({
                    ...
                    switchControl: {
                      ...
                      onChange: (checked: boolean) =>
                        setBloc1Grp2Switches((prev) => prev.map((v, idx) => (idx === i ? checked : v))),
                    },
                  })),
                },
              ],
              ...
              grpPanels: [
                {
                  ...
                  grpLabel: { text: "[Grp Label]:", variant: "body2" },
                  shuffleAllLabel: { text: "Shuffle All:", variant: "body2" },
                  ...
                  selectRows: selectRowLabels.map((label, i) => ({
                    ...
                    select: {
                      value: bloc1Grp1SelectValues[i] ?? MOCK_SELECT_OPTIONS[0],
                      options: MOCK_SELECT_OPTIONS,
                      onChange: (value: string) =>
                        setBloc1Grp1SelectValues((prev) => prev.map((v, idx) => (idx === i ? value : v))),
                      fullWidth: true,
                    },
                    reloadButton: { label: "Reload", onClick: () => {}, size: "small" },
                  })),
                },
              ],
            },
              ...
              grpPanels: [
                {
                  ...
                  promptField: {
                    placeholder: "text field...",
                    defaultValue: bloc2Grp1OrdersPrompt,
                    onBlur: setBloc2Grp1OrdersPrompt,
                    size: "small",
                    fullWidth: true,
                  },
                  resetButton: { label: "Reset", onClick: () => {}, size: "small" },
                ...
                },
                {
                  ...
                  promptField: {
                    placeholder: "text field...",
                    defaultValue: bloc2Grp2OrdersPrompt,
                    onBlur: setBloc2Grp2OrdersPrompt,
                    size: "small",
                    fullWidth: true,
                  },
                  resetButton: { label: "Reset", onClick: () => {}, size: "small" },
              ...
              grpPanels: [
                {
                  ...
                  switchItems: bloc2SwitchItemLabels.map((label, i) => ({
                    ...
                    switchControl: {
                      ...
                      onChange: (checked: boolean) =>
                        setBloc2Grp1Switches((prev) => prev.map((v, idx) => (idx === i ? checked : v))),
                    },
                  })),
                },
                {
                  ...
                  switchItems: bloc2SwitchItemLabels.map((label, i) => ({
                    ...
                    switchControl: {
                      ...
                      onChange: (checked: boolean) =>
                        setBloc2Grp2Switches((prev) => prev.map((v, idx) => (idx === i ? checked : v))),
                    },
                  })),
                },
              ],
              ...
              grpPanels: [
                {
                  ...
                  selectRows: selectRowLabels.map((label, i) => ({
                    ...
                    label: { text: `${label}:`, variant: "body2" },
                    select: {
                      value: bloc2Grp1SelectValues[i] ?? MOCK_SELECT_OPTIONS[0],
                      options: MOCK_SELECT_OPTIONS,
                      onChange: (value: string) =>
                        setBloc2Grp1SelectValues((prev) => prev.map((v, idx) => (idx === i ? value : v))),
                      fullWidth: true,
                    },
                    reloadButton: { label: "Reload", onClick: () => {}, size: "small" },
                  })),
        ...
        summaryBloc: {
          ...
          tuneupComposition: {
            titleLabel: { text: "Tune-up Composition:", variant: "subtitle1" },
            ...
            anglesOptions: [
              {
                ...
                label: {
                  text: "Above",
                  variant: "body2",
                  color: selectedAngle === "above" ? "success.main" : undefined,
                },
              },
              {
                ...
                label: {
                  text: "Horizontal",
                  variant: "body2",
                  color: selectedAngle === "horizontal" ? "success.main" : undefined,
                },
              },
              {
                key: "angle-below",
                ...
                label: {
                  text: "Below",
                  variant: "body2",
                  color: selectedAngle === "below" ? "success.main" : undefined,
                },
              },
            ],
            ...
            directionsOptions: [
              {
                ...
                label: {
                  text: "Front",
                  variant: "body2",
                  color: selectedDirection === "front" ? "success.main" : undefined,
                },
              },
              {
                key: "direction-side",
                ...
                label: {
                  text: "Side",
                  variant: "body2",
                  color: selectedDirection === "side" ? "success.main" : undefined,
                },
              },
              {
                key: "direction-back",
                ...
                label: {
                  text: "Back",
                  variant: "body2",
                  color: selectedDirection === "back" ? "success.main" : undefined,
                },
              },
            ],
          },
          promptIdea: {
            ...
            summaryPromptLabel: { text: "Summary Prompt:", variant: "body2" },
            summaryPromptField: {
              placeholder: "Text area Field...",
              defaultValue: summaryPromptValue,
