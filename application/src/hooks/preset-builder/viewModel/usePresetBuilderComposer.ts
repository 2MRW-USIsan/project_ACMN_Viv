  ...
  return {
    viewModel: {
      ...
      presetBuilderBody: {
        ...
        buildersSectionLabel: { text: "Builders Field:", variant: "subtitle1" as const },
        shuffleButton: { label: "Shuffle", onClick: () => {}, size: "small" as const },
        copyButton: { label: "Copy", onClick: () => {}, size: "small" as const },
        pasteButton: { label: "Paste", onClick: () => {}, size: "small" as const },
        resetButton: { label: "Reset", onClick: () => {}, size: "small" as const },
        clearButton: { label: "Clear", onClick: () => {}, size: "small" as const },
        presetsTemplateLabel: { text: "Presets Template:", variant: "body2" as const },
        presetsTemplateField: { placeholder: "Text area Field...", defaultValue: "", onBlur: () => {}, multiline: true, rows: 14, fullWidth: true },
        orderPresetsLabel: { text: "Order Presets:", variant: "body2" as const },
        orderPresetsField: { placeholder: "Text area Field...", defaultValue: "", onBlur: () => {}, multiline: true, rows: 14, fullWidth: true },
      },
